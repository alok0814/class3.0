...
if __name__ == '__main__':
    ...
    # ChatGPTの性格設定
    personality = "I am an enthusiastic and diligent student. I love learning and helping others with their questions. How can I assist you today?"
    ...
    while True:
        ...
        if text:
            ...
            response = openai.ChatCompletion.create(
                ...
                max_tokens=30,  # 応答の最大トークン数を30に制限
                temperature=0.7,  # 応答の多様性を調整
                personality_id=personality  # ChatGPTの性格設定
            )
